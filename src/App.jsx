...
import{ScoutCenter}from'./pages/ScoutCenter.jsx';
...
function App(){
  ...
  async function loadAll(){
    ...
    getItems('matches',[]).then(items=>{
      setMatches(items);
      if(!selectedMatchId&&items[0]?.id)setSelectedMatchId(items[0].id);
    });
